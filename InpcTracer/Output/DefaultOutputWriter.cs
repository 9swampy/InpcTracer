namespace InpcTracer.Output
{
  ...
  : IOutputWriter
  {
    ...
    public IDisposable Indent()
    {
      ...
      this.currentIndent = string.Format("{0}{1}", this.currentIndent, IndentString);
      return unindenter;
    }
    ...
    : WriteState
    {
      public DefaultWriterState(DefaultOutputWriter writer) : base(writer)
      {
      }
    ...
    : WriteState
    {
      public IndentNextNonNewLineCharacterWriterState(DefaultOutputWriter writer) : base(writer)
      {
      }
